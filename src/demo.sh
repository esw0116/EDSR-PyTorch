...
python main.py --model EDSR_CLS --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset --data_test Set5 --pre_train download
...
#python main.py --data_test DIV2K --data_range 1-10 --scale 4 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --pre_train download --test_only --chop
